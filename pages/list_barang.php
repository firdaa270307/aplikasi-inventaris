          ...
          <div class="search-field d-none d-md-block">
            <form class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                ...
                <input type="text" class="form-control bg-transparent border-0" placeholder="Cari Barang" name="cari">
              </div>
            </form>
          </div>
        ...
        <tr>
          ...
          <td>
            <a href="?p=list_barang&id_inventaris=<?= $data['id_inventaris'] ?>#gambar/<?= $data['gambar'] ?>">
              <img src="gambar/<?php echo $data['gambar']; ?>" id="preview" width="1500">
            </a>
          ...
          <td><?= $data['ket'] ?></td> -->
          <td>
            <a href="?p=detail_barang&id_inventaris=<?= $data['id_inventaris'] ?>" class="btn btn-md btn-success"><span class="mdi mdi-eye"></span></a>
            <a href="?p=edit_barang&id_inventaris=<?= $data['id_inventaris'] ?>" class="btn btn-md btn-primary"><span class="mdi mdi-grease-pencil"></span></a>
            <a onclick="return confirm('Apakah anda yakin untuk menghapusnya?')" href="pages/hapus_barang.php?id_inventaris=<?= $data['id_inventaris'] ?>" class="btn btn-md btn-danger"><span class="mdi mdi-delete"></span></a>
          </td>
        </tr>
    <?php
      }
...
<footer class="">
            <div class="container-fluid d-flex justify-content-between">
              <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © Firda Linda</span>
