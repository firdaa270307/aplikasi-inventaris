            ...
            <div class="row">
              ...
              <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Selamat Datang, <?= $user ?>! <i class="mdi mdi-account mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">Selamat Datang Di Aplikasi Inventaris Kantor</h2>
                    <h6 class="card-text">Selamat Anda Telah Memasuki Aplikasi Inventaris, Selamat Beraktivitas <?= $user ?>!</h6>
                  </div>
                </div>
